// src/pages/LMHRiskForm.js - Add EGBC/FPBC inspection report fields
...
const LMHRiskForm = () => {
  ...
  // EGBC/FPBC Inspection Report Fields
      ...
      <div className="form-content">
        ...
        {activeSection === 'results' && (
          <div className="form-section" style={{borderTop: '4px solid #4caf50'}}>
                  ...
                  <div>
                    ...
                    <div style={{marginTop: '24px'}}>
                      ...
                      {segments.map((seg, idx) => {
                        ...
                        return risk && (
                          <div key={seg.id} style={{background: 'white', padding: '12px', borderRadius: '6px', marginBottom: '8px', border: `2px solid ${risk.color}`, borderLeft: `6px solid ${risk.color}`}}>
                          ...
                          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '12px'}}>
                            ...
                            {entireRoad.quickCapture?.photosCollected && (
                              <div style={{background: '#e8f5e9', padding: '16px', borderRadius: '8px', textAlign: 'center'}}>
                                ...
                                <div style={{fontSize: '24px', fontWeight: 'bold', color: '#2e7d32'}}>✓</div>
                              </div>
                            )}
                          </div>
                        </div>
            ...
            {/* INSPECTION REPORT FIELDS (EGBC/FPBC 3.7.2) */}
            <div style={{background: '#e3f2fd', padding: '20px', borderRadius: '8px', marginTop: '24px', border: '2px solid #1976d2'}}>
              ...
              <div className="form-group" style={{marginBottom: '16px'}}>
                ...
                <div style={{fontSize: '12px', color: '#666', marginBottom: '8px', fontStyle: 'italic'}}>
                  List maintenance/repair items with priority. Example: "Clean culvert KM 5.4 - High (Safety)" or "Grade surface - Medium (Maintenance)"
                </div>
                <textarea
              ...
              <div style={{marginBottom: '16px'}}>
                ...
                {inspectionReport.requiresSpecialist && (
                  <textarea
                    ...
                    placeholder="Specify specialist type and reason. Example: 'P.Eng required for retaining wall structural assessment' or 'Geomorphologist for fan hazard evaluation'"
                ...
                {(() => {
                  ...
                  return rec.frequency && (
                    <div style={{background: '#fff3e0', padding: '10px', borderRadius: '4px', marginBottom: '12px', fontSize: '13px'}}>
                      <strong>Recommended based on risk:</strong> {rec.frequency} ({rec.months}) - {rec.reason}
                    </div>
                  );
                })()}
                <div className="form-group">
